...
export default function CustomScrollbar2({ children, className }) {
  ...
  return (
    <div
      className={"vr-scrollhost-container"}
      onMouseOver={handleMouseOver}
      onMouseOut={handleMouseOut}
    >
      <div
        ref={scrollHostRef}
        className={`vr-scrollhost ${className}`}
      >
        {children}
      </div>
      <div className={"vr-scroll-bar"} style={{ opacity: hovering ? 1 : 1 }}>
        <div
          className={"vr-scroll-thumb"}
